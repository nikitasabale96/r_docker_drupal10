...
// elseif (
//   ($form_state->getValue(['lab_actions']) == 3) &&
//   ($form_state->getValue(['lab_experiment_actions']) == 0) &&
//   ($form_state->getValue(['lab_experiment_solution_actions']) == 0)
// ) {
// var_dump("hi");die;
//   // if (strlen(trim($form_state->getValue(['message']))) <= 30) {

//   //   \Drupal::messenger()->addMessage(
//   //     "Please mention the reason for disapproval. Minimum 30 character required",
//   //     'error'
//   //   );
...
//   //   \Drupal::messenger()->addMessage(
//   //     t('You do not have permission to Bulk Dis-Approved and Deleted Entire Lab.'),
//   //     'error'
//   //   );
...
//     t(
//       "Dear @contributor_name,\n\n
// Your uploaded solutions for the lab have been disapproved.\n\n
// Title of Lab: @lab_title\n\n
...
//   //   \Drupal::messenger()->addMessage(
//   //     t('Dis-Approved and Deleted Entire Lab.'),
//   //     'status'
//   //   );
//   // }
//   // else {
...
//   //   \Drupal::messenger()->addMessage(
//   //     t('Error Dis-Approving and Deleting Entire Lab.'),
//   //     'error'
//   //   );
//   // }
// }
...
//   \Drupal::messenger()->addMessage(
//     t('Please select only one action at a time'),
//     'error'
//   );
